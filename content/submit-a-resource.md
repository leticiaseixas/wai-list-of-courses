...
<form id="form-submit-an-offer">
  ...
  <fieldset id="offer-accessibility-support">
    ...
    <p class="expl">Indicate what accessibility support is provided, if applicable (see guidance on <a href="https://www.w3.org/WAI/teach-advocate/accessible-presentations/">How to Make Your Presentations Accessible to All</a>). Include details in the text box.</p>
