...
<p>
This form allows you to provide information about courses, training, and certification on web accessibility. If you wish to update an existing resource, please, upload the file provided when first submiting through the following link: <a href="#">Load resource information</a>.
</p>
