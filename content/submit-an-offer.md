...
<p>
  This form allows you to provide information about courses, training, and certification on web accessibility. Please, to update an existing resource, use the following button to upload the file provided when first submiting your resource.</p>
