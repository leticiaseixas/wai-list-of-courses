...
<a href="#left-col" id="skip_link_filters" class="button button--skip-link">{{ strings.skip_to_filters }}</a>
<a href="#courses-list" id="skip_link_results" class="button button--skip-link">{{ strings.skip_to_results }}</a>
